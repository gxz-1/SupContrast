...
def set_loader(opt):
    ...
    if opt.dataset == 'sp':
        ...
        transforms.RandomResizedCrop((500, 500), scale=(0.8, 1.0)),  # 随机缩放裁剪
    ...
    if opt.dataset == 'cifar10':
        ...
        train_dataset = datasets.ImageFolder(root=opt.data_folder,
                                            transform=TwoCropTransform(train_transform))
    # elif opt.dataset == 'rf':
    #     train_dataset=RFDataset(data_dir=opt.data_folder, train_transform=TwoCropTransform(train_transform)) 
    elif opt.dataset == 'sp':
